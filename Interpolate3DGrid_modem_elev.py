...
for zz in range(elev_mod.grid_z.shape[0]):
    ...
    print 'New depth={0:.2f}; elev depth={1:.2f}'.format(avg_mod.grid_z[avg_zz],
                                                        elev_mod.grid_z[zz])
...
elev_mod.write_model_file(save_path=r"/mnt/hgfs/ModEM/LV",
                     model_fn_basename='lv_sm_topo_avg.rho')

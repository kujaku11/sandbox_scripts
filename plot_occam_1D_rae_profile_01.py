...
for ii, ss in enumerate(station_list):
    ...
    ax.grid(which="both", alpha=0.7, color=(0.75, 0.75, 0.75))
    ...
    if ii == 0:
        ax.set_ylabel("Depth (ft)", fontdict={"size": 10, "weight": "medium"})
        ax2.tick_params(labelleft="off", labelright="off", right="off", left="off")
    elif ii == len(station_list) - 1:
        ax2.set_ylabel("Depth (m)", fontdict={"size": 10, "weight": "medium"})
        ax.tick_params(labelleft="off", labelright="off", right="off", left="off")
        ...
        ax2.tick_params(labelleft="off", labelright="off", right="off", left="off")
    if ii == 2:
        ax.set_xlabel("Resistivity (Ohm-m)", fontdict={"size": 10, "weight": "medium"})
plt.show()

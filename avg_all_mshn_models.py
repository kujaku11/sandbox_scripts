...
nr_ws_sm2 = interp_grid(
    ws_sm2, modem_all, shift_east=d_east, shift_north=d_north, smooth_kernel=None, pad=5
)

nr_ws_sm3 = interp_grid(
    ws_sm3, modem_all, shift_east=d_east, shift_north=d_north, smooth_kernel=None, pad=5
)
...
avg_res = (nr_ws_sm2 * nr_tip * modem_all.res_model) ** (1.0 / 3)

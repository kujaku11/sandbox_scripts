...
for s_arr in d_obj.station_locations:
    l1 = ax.scatter(s_arr["lon"], s_arr["lat"], marker="v", s=15, c="k")
    ax.text(
        s_arr["lon"],
        s_arr["lat"] + 0.004,
        s_arr["station"][2:],
...
ax.imshow(im, aspect="equal", origin="upper", extent=(-119.11, -118.75, 37.8, 37.95))  #
...
fig.savefig(r"c:\Users\jpeacock-pr\Google Drive\JVG\mb_station_map.pdf", dpi=300)

...
comb_mod.write_model_file(save_path=r"c:\Users\jpeacock\Documents\MonoBasin\modem_inv\inv_03",
...
md = modem.Data()
md.read_data_file(r"c:\Users\jpeacock\Documents\MonoBasin\modem_inv\inv_02\ml_modem_data_z05_t02.dat")
...
ax_lv.pcolormesh(plot_east, plot_north, np.log10(lv_res[:, :, 33]), 
                 cmap='jet_r',
                 vmin=-1, 
                 vmax=4)
ax_co = fig.add_subplot(1, 3, 2, aspect='equal', sharex=ax_lv, sharey=ax_lv)
ax_co.pcolormesh(plot_east, plot_north, np.log10(comb_res[:, :, 33]), 
                 cmap='jet_r',
                 vmin=-1, 
                 vmax=4)
                 
ax_sm = fig.add_subplot(1, 3, 3, aspect='equal', sharex=ax_lv, sharey=ax_lv)
ax_sm.pcolormesh(plot_east, plot_north, np.log10(smooth_comb_res[:, :, 33]), 
                 cmap='jet_r',
                 vmin=-1, 
                 vmax=4)

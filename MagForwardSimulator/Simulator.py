...
def PlotFwrSim(
    ...
    def MagSurvey2D(
        ...
        return plotMagSurvey2D(
            survey, a, b, Profile_npt, data=data, fig=fig, ax=ax, vmin=vmin, vmax=vmax
        )
    ...
    def MagSurveyProfile(
        ...
        return plotProfile(survey, a, b, Profile_npt, data=data, fig=fig, ax=ax)
...
def ViewMagSurvey2D(survey):
    def MagSurvey2D(East, North, Width, Height, Azimuth, Length, Npts, Profile):
        ...
        if Profile:
            ...
            plotProfile(survey, a, b, Npts, data=None, fig=fig, ax=ax2)
...
def plotMagSurvey2D(
    survey, a, b, npts, data=None, fig=None, ax=None, vmin=None, vmax=None
):
    """
    ...
    ax.text(x[-1], y[-1], "B", fontsize=16, color="w", horizontalalignment="right")

    return


def plotProfile(survey, a, b, npts, data=None, fig=None, ax=None):
    """
    Plot the data and line profile inside the spcified limits
    """
...
def ViewPrism(param):
    ...
    out = widgets.interactive(
        ...
        dx=widgets.FloatSlider(
            min=1.0, max=2000.0, step=1.0, value=100, continuous_update=False
        ),
        dy=widgets.FloatSlider(
            min=1.0, max=2000.0, step=1.0, value=1000, continuous_update=False
        ),
        dz=widgets.FloatSlider(
            min=1.0, max=2000.0, step=1.0, value=500, continuous_update=False
        ),
        ...
        elev=widgets.FloatSlider(
            min=-1000.0, max=1000.0, step=1.0, value=250.0, continuous_update=False
        ),

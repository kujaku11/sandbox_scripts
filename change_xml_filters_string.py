...
hx_filter_str = (
    "nT to counts, magnetic field 3 pole Butterworth low-pass, Hx time offset"
)
hy_filter_str = (
    "nT to counts, magnetic field 3 pole Butterworth low-pass, Hy time offset"
)
hz_filter_str = (
    "nT to counts, magnetic field 3 pole Butterworth low-pass, Hz time offset"
)
e_filter_str = (
    "mV/km to V/m, V/m to V, V to counts, electric field 1 pole "
...
new_e = (
    "electric_si_units, dipole_length, "

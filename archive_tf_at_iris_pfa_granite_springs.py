...
# path to TF files
edi_path = Path(
    r"c:\Users\jpeacock\OneDrive - DOI\MTData\GraniteSprings\EDI_Files_birrp\Rotated_m13_deg"
)
...
survey_summary = pd.read_csv(
    r"c:\Users\jpeacock\OneDrive - DOI\MTData\GraniteSprings\survey_summary.csv"
)
...
for edi_file in edi_path.glob("*.edi"):
    ...
    mt_obj.survey_metadata.citation_dataset.title = (
        "Magnetotelluric data in the Granite Springs region, Nevada for "
    ...
    mt_obj.station_metadata.geographic_name = "Granite Springs, NV, USA"
    mt_obj.survey_metadata.geographic_name = "Granite Springs, NV, USA"

...
for line in line_list:
    edi_list = [
        os.path.join(edi_path, fn) for fn in os.listdir(edi_path) if fn[0:4] == line
    ]
    ...
    ps.plot()
    ps.save_figure(
        r"c:\Users\jpeacock\OneDrive - DOI\med_report\report\figures\med_pt_ps_line{0}00.svg".format(
            line
        ),
        file_format="svg",
        fig_dpi=600,

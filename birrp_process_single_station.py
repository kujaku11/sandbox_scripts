...
plot_obj, comb_edi = zp_obj.process_data(
    df_list=[4096, 256, 16],
    use_blocks_dict={4096: [0, 1, 2], 256: [1, 2], 16: [1, 2]},
    max_blocks=4,
    notch_dict={4096: n_dict_4096, 256: None, 16: None},
    birrp_param_dict=bp,
    sr_dict={4096: (1000.0, 6.25), 256: (6.249, 0.016), 16: (0.0161, 0.0001)},
)
...
shutil.copy(
    comb_edi, os.path.join(survey_path, "EDI_Files_birrp", "{0}.edi".format(station))
)

        ...
        for ii, xx in enumerate(mod_obj.grid_north[north_pad:-north_pad]):
            ...
            lines.append(
                "{0:>12.1f}{1:12.1f}{2:12.1f}{3:12.2f}".format(
                    xx + c_north, yy + c_east, zz, mod_obj.res_model[ii, jj, kk]
                )
            )
...
# --> write data xyz file
d_lines = [
    "{0:<8}{1:>14}{2:>14}{3:>14}".format("station", "east", "north", "elevation")
]
for s_arr in d_obj.station_locations:
    d_lines.append(
        "{0:<8}{1:>14.2f}{2:>14.2f}{3:>14.2f}".format(
            s_arr["station"], s_arr["east"], s_arr["north"], s_arr["elev"]
        )
    )

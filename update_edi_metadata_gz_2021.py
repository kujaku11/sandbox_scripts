...
survey_csv_fn = r"c:\Users\jpeacock\OneDrive - DOI\Geysers\CEC\2021_EDI_files_birrp_processed\gz_2021_survey_summary.csv"

# test_fn = Path(r"c:\Users\jpeacock\Documents\GitHub\sandbox_scripts\test.edi")
# if test_fn.exists():
#     test_fn.unlink()
edi_path = Path(
    r"c:\Users\jpeacock\OneDrive - DOI\Geysers\CEC\2021_EDI_files_birrp_processed\GeographicNorth_rr_frn"
)
...
for edi_fn in edi_list:
    ...
    sdf = survey_df.loc[survey_df.station == (m.station[2:])]
    if sdf.empty:
        sdf = survey_df.loc[survey_df.station == m.station]
    ...
    m.survey_metadata.citation_dataset.year = "2021"
    ...
    m.survey_metadata.name = "The Geysers Phase 1"
    ...
    m.survey_metadata.summary = "1st of 3 repeat MT measurements at The Geysers to monitor the steam field"
    m.survey_metadata.id = "GZ2021"
    ...
    m.station_metadata.location.declination.value = 13.46
    ...
    m.station_metadata.transfer_function.processed_date = "2022-5-10"

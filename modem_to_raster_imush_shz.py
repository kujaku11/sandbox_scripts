...
model_fn = r"c:\Users\jpeacock\Documents\iMush\modem_inv\shz_inv_02\shz_avg_z04_t03_c02_NLCG_014.rho"

save_path = r"c:\Users\jpeacock\Documents\iMush\modem_inv\shz_inv_02\depth_slices"
#save_path = r"/mnt/hgfs/jpeacock/Documents/LV/Maps/geo_model_slices_02"
#model_center = (-118.833, 37.815) # lv center
#model_center = (-122.203899, 46.252578) # old shz inv the smaller one
#ll_cc = (-123.511, 45.32) # the old shz inv the smaller one
model_center = (-122.194629, 46.310461)
ll_cc = (-122.607, 45.885)
...
modem_raster.lower_left_corner = (ll_cc[0]-0.025, ll_cc[1]-0.012)

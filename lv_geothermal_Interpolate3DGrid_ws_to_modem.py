...
modem_data_fn = r'/home/jpeacock/Documents/ModEM/LV/geo_inv2/lv_geo_err12_tip10_edit.dat'

modem_model_fn = r"/home/jpeacock/Documents/ModEM/LV/geo_inv2/sm_lv_big.rho"
ws_model_fn = r"/home/jpeacock/Documents/wsinv3d/LV/geothermal_deep_02/lv_geo_deep_model.03_05"
ws_data_fn = r"/home/jpeacock/Documents/wsinv3d/LV/geothermal_deep_02/WS_data_lv_geo_deep_8_deep.dat"
ws_station_fn = r"/home/jpeacock/Documents/wsinv3d/LV/geothermal_deep_02/WS_Station_Locations.txt"
...
new_res = np.zeros((modem_mod.grid_north.shape[0],
...
for zz in range(modem_mod.grid_z.shape[0]):
    ...
    print 'New depth={0:.2f}; old depth={1:.2f}'.format(modem_mod.grid_z[zz],
                                                        ws_mod.grid_z[old_zz])
...
modem_mod.write_model_file(save_path=r"/home/jpeacock/Documents/ModEM/LV/geo_inv2",

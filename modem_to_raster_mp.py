...
save_path = r"c:\Users\jpeacock\Documents\MountainPass\modem_inv\inv_02\depth_slices"
...
modem_raster.lower_left_corner = (ll_cc[0]+0.0095, ll_cc[1]+.00575)
modem_raster.save_path = save_path
modem_raster.projection = 'WGS84'
modem_raster.rotation_angle = 0.0
modem_raster.write_raster_files(cell_size=400)
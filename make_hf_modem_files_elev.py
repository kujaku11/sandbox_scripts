...
model_fn = (
    r"c:\Users\jpeacock\Documents\Geothermal\Umatilla\modem_inv\inv01\hf_sm02.rho"
)
...
mm = modem.ModelManipulator(model_fn=new_model_fn, data_fn=n_dfn, depth_index=27)

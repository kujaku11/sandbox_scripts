...
# path to TF files
edi_path = Path(
    r"c:\Users\jpeacock\OneDrive - DOI\MTData\MSHS\EDI_Files_Archive"
)
...
survey_summary = pd.read_csv(
    r"c:\Users\jpeacock\OneDrive - DOI\MTData\MSHS\survey_summary.csv"
)
...
for edi_file in edi_path.glob("*.edi"):
    ...
    mt_obj.station = f"mshs{mt_obj.station}"
    ...
    mt_obj.survey_metadata.citation_dataset.title = (
        "Magnetotelluric data of the southern Mount St. Helens area, "

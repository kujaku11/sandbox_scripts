...
# path to TF files
edi_path = Path(
    r"c:\Users\jpeacock\OneDrive - DOI\MTData\MountainHome\EDI_Files_Archive\usgs"
)
...
survey_summary = pd.read_csv(
    r"c:\Users\jpeacock\OneDrive - DOI\MTData\MountainHome\survey_summary.csv"
)
...
for edi_file in edi_path.glob("*.edi"):
    ...
    xml_obj.site.data_quality_notes.comments.value = (
        "Power lines and cultural noise"
    )

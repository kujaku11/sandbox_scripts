...
old_model_fn = r"/home/jpeacock/Documents/ModEM/LV/lv_sm_avg.rho"
...
if interpolation_dim == '2d':
    ...
    north, east = np.broadcast_arrays(old_mod.grid_north[:, None], 
    ...
    north, east, vert = np.broadcast_arrays(old_mod.grid_north[:, None, None], 
...
new_mod.write_model_file(save_path=r"/home/jpeacock/Documents/ModEM/LV",
                     model_fn_basename='lv_sm_avg_interp.rho')

...
s_arr = np.loadtxt(
    ...
    delimiter=",",
    skiprows=1,
    dtype=[("station", "|S5"), ("lat", np.float), ("lon", np.float)],
)
...
ax.xaxis.set_major_locator(MultipleLocator(2.0 / 60))
ax.yaxis.set_major_locator(MultipleLocator(2.0 / 60))
ax.xaxis.set_minor_locator(MultipleLocator(0.5 / 60))
ax.yaxis.set_minor_locator(MultipleLocator(0.5 / 60))
ax.grid(which="major")

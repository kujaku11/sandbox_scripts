...
ax_mb.pcolormesh(
    grid_east, grid_north, np.log10(mb_res[:, :, 33]), cmap="jet_r", vmin=-1, vmax=4
)

ax_lv = fig.add_subplot(2, 2, 2, aspect="equal", sharex=ax_mb, sharey=ax_mb)
ax_lv.pcolormesh(
    grid_east, grid_north, np.log10(lv_res[:, :, 33]), cmap="jet_r", vmin=-1, vmax=4
)
ax_co = fig.add_subplot(2, 2, 3, aspect="equal", sharex=ax_mb, sharey=ax_mb)
ax_co.pcolormesh(
    grid_east, grid_north, np.log10(comb_res[:, :, 33]), cmap="jet_r", vmin=-1, vmax=4
)

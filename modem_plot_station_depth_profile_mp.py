...
# 
# =============================================================================
d_fn = r"c:\Users\jpeacock\Documents\MountainPass\modem_inv\inv_08\mp_modem_data_z05.dat"
...
#    lines.append('# elev = {0:.2f} m'.format(elev['elev'][elev_find]))
    ...
    lines.append('\n'.join(['{0:<12.2f} {1:<12.3f}'.format(d, res) 
                            for d, res in zip(depth_1d[0:46], 
                                              res_1d[0:46])]))
    txt_fn = r"c:\Users\jpeacock\Documents\MountainPass\depth_profiles\{0}.txt".format(s_arr['station'])
    ...
    l2 = ax.plot(res_1d, depth_1d+m_obj.grid_z[d_index], ls='steps',
                 color=(1, .6, .1))

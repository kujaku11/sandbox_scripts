...
cols = ['site_name', 'latitude', 'longitude', 'dep_id', 'commod1', 'commod2', 
        'commod3', 'dev_stat', 'structure', 'hrock_type', 'ore']

exempt_list = ['ash', 'cement rock', 'clay', 'construction', 'crushed/broken',
               'dimension', 'free', 'fire clay (refractory)', 'limestone',
               'metal', 'sand and gravel', 'stone', 'water', 
               'volcanic materials', '']
...
for ii in range(df.shape[0]):
    site_ores = df.loc[ii, 'commod1'].lower().split(',')+\

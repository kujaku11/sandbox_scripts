...
survey_csv_fn = r"c:\Users\jpeacock\OneDrive - DOI\Geysers\CEC\2023_EDI_files_birrp_processed\2023_survey_summary.csv"

# test_fn = Path(r"c:\Users\jpeacock\Documents\GitHub\sandbox_scripts\test.edi")
# if test_fn.exists():
#     test_fn.unlink()
edi_path = Path(
    r"c:\Users\jpeacock\OneDrive - DOI\Geysers\CEC\2023_EDI_files_birrp_processed\GeographicNorth_rr_frn"
)
...
for edi_fn in edi_list:
    ...
    m.survey_metadata.name = "The Geysers Phase 3"
    ...
    m.survey_metadata.summary = "3rd of 3 repeat MT measurements at The Geysers to monitor the steam field"
    m.survey_metadata.id = "GZ2023"
    ...
    m.station_metadata.location.declination.value = 13.3
    ...
    m.station_metadata.transfer_function.processed_date = "2023-5-10"

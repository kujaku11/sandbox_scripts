...
edi_path = (
    r"c:\Users\jpeacock\Documents\MountainPass\EDI_Files_birrp\Edited\geographic_north"
)
...
# Make the data file
# ==============================================================================
inv_period_list = np.logspace(-np.log10(625.0), np.log10(1024), num=23)
...
mod_obj.n_layers = 40
mod_obj.z1_layer = 20
mod_obj.z_target_depth = 60000.0
mod_obj.z_bottom = 250000.0

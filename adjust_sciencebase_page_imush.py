...
ng_citation = 'Bedrosian, P. A., Peacock, J. R., Bowles-Martinez, E., '+\
              ...
              'and a top-down control on arc magmatism, Nature Geoscience, '+\
              '11, p. 865-870.' 
...
for child_id in child_ids:
    ...
    child_json['webLinks'][0]['title'] = 'Crustal inheritance and a top-down '+\
                                         'control on arc magmatism at Mount'+\
                                         'St. Helens, in Nature Geoscience'

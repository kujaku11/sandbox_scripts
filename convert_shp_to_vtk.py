...
fn = Path(r"c:\Users\jpeacock\Downloads\GIS\states_THO_clip_pnts.shp")
# bounds = {"longitude": (-128, -100), "latitude": (31, 50)}
bounds = None
project_to = {"epsg": 26911}
custom_crs = "+proj=tmerc +lat_0=0 +lon_0=-113.25 +k=0.9996 +x_0=4511 +y_0=0 +ellps=WGS84 +units=km +no_defs"
# bounds = None
# project_to = None
# custom_crs = None
...
if project_to is not None:
    ...
    for tfn in fn.parent.glob("temp*"):
        tfn.unlink()
else:
    f = FileShp.read(fn)
    f.toVTK(Path(fn.parent, fn.stem).as_posix())

...
h = zp.Z3D_to_edi(r"d:\Peacock\MTData\Geysers\gz02\TS")
h.df_list = [16]
h.rr_station_dir = [r"d:\Peacock\MTData\Geysers\gz08\TS"] 
#                    r"d:\Peacock\MTData\Geysers\gz06\TS"]
#h = zp.Z3D_to_edi(r"d:\Peacock\MTData\Geysers\gz02")
#h.df_list = [256]
#h.rr_station_dir = [r"d:\Peacock\MTData\Geysers\gz08", 
#                    r"d:\Peacock\MTData\Geysers\gz06"]
#mtts = h.make_mtpy_ascii_files()
...
##s_test.ilev = 1
##s_test.nrr = 0
#s_test.write_script_file(script_fn=r"c:\Users\jpeacock\Documents\GitHub\sandbox\test.script")
##s_test.write_config_file(r"c:\Users\jpeacock\Documents\GitHub\sandbox\test_script.cfg")
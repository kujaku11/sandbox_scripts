...
edi_path = survey_dir.joinpath("EDI_Files_aurora_geomag_rr_coherence")
...
# geomagnetic H5 file
geomag_mth5 = Path(
    r"c:\Users\jpeacock\OneDrive - DOI\MTData\CM2025\mth5\usgs_geomag_frn_xy.h5"
)
...
station_list = [
    ...
    # {"local": "cm204", "remote": "cm231"},
    {"local": "cm205", "remote": "cm209"},
    # {"local": "cm206", "remote": "cm209"},
    # {"local": "cm207", "remote": "cm209"},
    # {"local": "cm208", "remote": "cm211"},
    # {"local": "cm209", "remote": "cm206"},
    # {"local": "cm210", "remote": "cm225"},
    # {"local": "cm211", "remote": "cm220"},
    ...
    # {"local": "cm223", "remote": "cm227"},
    # {"local": "cm224", "remote": "cm231"},
    # {"local": "cm225", "remote": "cm213"},
    # {"local": "cm226", "remote": "cm215"},
    # {"local": "cm227", "remote": "cm212"},
    # {"local": "cm228", "remote": "cm209"},

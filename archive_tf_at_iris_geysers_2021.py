...
# path to TF files
edi_path = Path(
    r"c:\Users\jpeacock\OneDrive - DOI\Geysers\CEC\2021_EDI_files_birrp_processed\GeographicNorth_rr_frn\updated"
)
...
survey_summary = pd.read_csv(
    r"c:\Users\jpeacock\OneDrive - DOI\MTData\GZ2021\survey_summary.csv"
)
...
for edi_file in edi_path.glob("*.edi"):
    ...
    mt_obj.station = change_station_name(mt_obj.station, year)
    ...
    mt_obj.survey_metadata.citation_dataset.title = (
        ...
        f"field, northern California: Phase 1 ({year})"
    )
    ...
    mt_obj.survey_metadata.citation_journal.doi = "https://pangea.stanford.edu/ERE/db/GeoConf/papers/SGW/2024/Peacock.pdf"
    ...
    mt_obj.station_metadata.provenance.comments = "Time series archived on Science Base at https://doi.org/10.5066/P14BJG2A."

...
m2r.save_path = r"c:\Users\jpeacock\OneDrive - DOI\Geothermal\Umatilla\modem_inv\inv_06\depth_slices"
m2r.projection = "NAD83"

for ii, carray in enumerate([c_top, c_crb, c_sed]):

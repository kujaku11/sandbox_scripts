...
station_list = [
    "TC{0:03}".format(ii) for ii in [17, 18, 19, 21, 22, 23, 24, 25, 26, 27, 28]
]
ns = len(station_list)
fs = 12
...
for ii, station in enumerate(station_list):
    ...
    m1 = ax2.scatter(
        r1.residual_array[station_find]["lon"],
    ...
    ax2.text(
        r1.residual_array[station_find]["lon"],
        r1.residual_array[station_find]["lat"] + 0.005,
        "{0}".format(station),
...
ax2.xaxis.set_major_locator(MultipleLocator(0.025))
...
fig.savefig(
    r"c:\Users\jpeacock\Documents\ShanesBugs\TorC_2018\torc_rms_sc_test.png", dpi=600
)
fig_02.savefig(
    r"c:\Users\jpeacock\Documents\ShanesBugs\TorC_2018\torc_rms_map_sc_test.png",
    dpi=600,
)

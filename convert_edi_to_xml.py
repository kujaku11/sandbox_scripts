...
prov_create_time.text = datetime.datetime.strftime(datetime.datetime.utcnow(),
                                                         dt_fmt)
...
copy_right_citation_authors.text = r"Jared R. Peacock, Maggie T. Mangan, Darcy K. McPhee, David A. Ponce"
...
site_data_qc_comments = ET.SubElement(site_data_qc, 'Comments',

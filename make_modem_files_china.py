...
# Inputs
#==============================================================================
edi_path = r"c:\Users\jpeacock\Documents\ShanesBugs\QHGH-MT-EDI"
save_path = r"c:\Users\jpeacock\Documents\ShanesBugs\QHGH-MT-EDI\inv_01"
topo_fn = r"c:\Users\jpeacock\Documents\ShanesBugs\QHGH-MT-EDI\qhgh_topo.asc"
...
#inv_period_list = np.logspace(-np.log10(300), np.log10(1500), num=23)
#
...
data_obj = modem.Data()
data_obj.model_epsg = 32647
data_obj.read_data_file(r"c:\Users\jpeacock\Documents\ShanesBugs\QHGH-MT-EDI\inv_01\qh_modem_data_z03.dat")
...
#--> add topography
mod_obj.add_topography_to_model(topographyfile=topo_fn)

...
utm_east = mod_obj.grid_east[east_pad:-east_pad] + c_east - 200.0
utm_north = mod_obj.grid_north[north_pad:-north_pad] + c_north + 150.0
...
ax.scatter(
    d_obj.station_locations.east, d_obj.station_locations.north, marker="v", c="k", s=25
)

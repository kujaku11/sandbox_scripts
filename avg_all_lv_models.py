...
nr_ws_hs1 = interp_grid(ws_hs1, base_model, shift_east=d_east, 
                        shift_north=d_north, smooth_kernel=7, pad=5)
nr_ws_sm1 = interp_grid(ws_sm1, base_model, shift_east=d_east, 
                        shift_north=d_north, smooth_kernel=7, pad=5)
nr_ws_sm2 = interp_grid(ws_sm2, base_model, shift_east=d_east, 
                        shift_north=d_north, smooth_kernel=7, pad=5)
...
avg_res = (nr_ws_sm2*nr_sm3*nr_sm_mb_t)**(1./3)
...
base_model.write_model_file(save_path=r"/home/jpeacock/Documents/ModEM/LV",
                            model_fn_basename='lv_avg_all_3.rho')
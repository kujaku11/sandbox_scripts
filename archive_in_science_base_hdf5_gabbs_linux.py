...
station_dir = r"/mnt/hgfs/MTData/GabbsValley"

### path to survey parameter spread sheet
csv_fn = r"/mnt/hgfs/MTData/GabbsValley/Archive/gv_survey_summary.csv"

### path to mth5 configuration file
cfg_fn = r"/mnt/hgfs/MTData/GabbsValley/gv_mth5.cfg"

### path to xml configuration file
xml_cfg_fn = r"/mnt/hgfs/MTData/GabbsValley/gv_archive.cfg"

### path to calibration files
calibration_dir = r"/mnt/hgfs/MTData/Ant_calibrations"

### paths to edi and png files if not already copied over
edi_path = r"/mnt/hgfs/MTData/GabbsValley/final_edi"
png_path = r"/mnt/hgfs/MTData/GabbsValley/final_png"

### SCIENCE BASE
### page id number
page_id = "5ca64a53e4b0c3b0064c26ac"
    ...
    if os.path.isdir(z3d_dir):
        ...
        with archive.Capturing() as output:
            ...
            if not os.path.isfile(
                ...
                shutil.copy(
                    os.path.join(edi_path, "{0}.edi".format(station)),
                    os.path.join(station_save_dir, "{0}.edi".format(station)),
                )
            if not os.path.isfile(
            ...
            for hh in ["hx", "hy", "hz"]:
                ...
                if mag_obj.id is not None and mag_obj.id != 0:
                    cal_fn = os.path.join(
                        calibration_dir, "ant_{0}.csv".format(mag_obj.id)
                    )

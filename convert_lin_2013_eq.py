...
line_arr = np.array([np.array(line.strip().split(), dtype=np.float)
                     for line in lines[0].split('le')])
...
a2vtk.pointsToVTK(r"C:\Users\jpeacock\Documents\LV\lv_3d_models\2013_lin_relocated_eq", y, x, z, 

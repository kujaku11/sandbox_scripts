...
res_fn_02 = r"c:\Users\jpeacock\Documents\SaudiArabia\modem_inv\inv_n30w\med_m_z05_c03_024.res"

if res_fn_02.endswith('.dat'):
    d = modem.Residual()
    res_fn_02 = d.calculate_residual_from_data(r"c:\Users\jpeacock\Documents\SaudiArabia\modem_inv\inv_n30w\med_modem_data_z03_t02_edit.dat",
                                               res_fn_02)
...
r = Rectangle((39.6, 24.4), .2, .2, color=(.5, .5, .5), alpha=.75,
              angle=30, zorder=0)
ax2.add_patch(r)

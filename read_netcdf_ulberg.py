...
mt_east, mt_north, mt_zone = gis_tools.project_point_ll2utm(46.44891, -122.031869)
msh_east, msh_north, msh_zone = gis_tools.project_point_ll2utm(46.199109, -122.188576)

d_east = (mt_east - msh_east) / 1000.0 + 7
d_north = (mt_north - msh_north) / 1000.0 + 18
depth = np.append(depth, depth[-1] + (depth[-1] - depth[-2]))
gridToVTK(
    r"c:\Users\jpeacock\Documents\iMush\imush_ulberg_velocity",
    msh_north / 1000.0 - north - d_north,
    msh_east / 1000.0 - east - d_east,
    depth,
    cellData={"vp": vtk_vp, "d_vp": vtk_dvp},
)

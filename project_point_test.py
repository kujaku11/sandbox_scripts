...
ll_cs.SetWellKnownGeogCS('WGS84')

utm_cs = osr.SpatialReference()
utm_cs.ImportFromEPSG(26742)

transform = osr.CoordinateTransformation(ll_cs, utm_cs)
print  transform.TransformPoint(lon, lat)

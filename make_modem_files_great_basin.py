...
# Parameters
# =============================================================================
edi_path = Path(r"c:\Users\jpeacock\OneDrive - DOI\Geothermal\GreatBasin\modem_inv\inv_02\edi_files")
save_path = Path(r"c:\Users\jpeacock\OneDrive - DOI\Geothermal\GreatBasin\modem_inv\inv_02")
...
bounds = {'lat':np.array([37.25, 41.5]),
          'lon':np.array([-124.5, -114.5])}
...
#==============================================================================
if not dfn.exists():
    inv_period_list = np.logspace(np.log10(1./100),
                                  np.log10(30000),
                                  num=23)

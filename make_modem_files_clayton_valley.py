...
save_path = Path(
    r"c:\Users\jpeacock\OneDrive - DOI\Geothermal\GreatBasin\modem_inv\cv_inv_01"
)
...
if not dfn.exists():
    s_edi_list = list(edi_path.glob("*.edi")) + [
        Path(
            r"c:\Users\jpeacock\OneDrive - DOI\EDI_FILES\USMTArray.NVS08.2020.edi"
        ),
        Path(
            r"c:\Users\jpeacock\OneDrive - DOI\EDI_FILES\USMTArray.NVS09.2020.edi"
        ),
    ]
...
if topography:
    mod_obj.add_topography_to_model2(
        topo_fn, airlayer_type="constant", max_elev=2600
    )

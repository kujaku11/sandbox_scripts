...
save_fn = (
    r"c:\Users\jpeacock\Documents\imush\bedrosian_imush_mt_2018_log10_clip_iris.nc"
)
model_center = (
    -122.080378,
    46.387827,
...
dataset.summary = (
    "Crustal resistivity model of Mount St. Helens and surrounding \n"
...
dataset.references = (
    "Bedrosian, P. A, Peacock, J. R., Bowles-Martinez, E., Schultz, A., Hill, G. J. \n"

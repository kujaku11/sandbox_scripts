...
if ptype == "map":
    ...
    for freq in [0.1, 1, 10, 30, 100, 300]:
        pr.plot_freq = 1.0 / freq
        pr.plot()

        pr.save_figure(
            f"c:\\Users\\jpeacock\\OneDrive - DOI\\Geysers\\CEC\\Reports\\phase2\\figures\\rpt_map_fault_planes_{freq}s.png",
            fig_dpi=300,
        )

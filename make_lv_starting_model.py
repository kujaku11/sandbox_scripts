...
co_mb.pcolormesh(
    grid_east,
    grid_north,
    np.log10(m_obj_nt.res_model[:, :, 30]),
    cmap="jet_r",
    vmin=-1,
    vmax=4,
)
...
co_mb.pcolormesh(
    grid_east, grid_north, np.log10(new_res[:, :, 30]), cmap="jet_r", vmin=-1, vmax=4
)
...
m_obj_nt.write_model_file(
    save_path=r"/home/jpeacock/Documents/ModEM/LV", model_fn_basename=r"lv_sm_avg.rho"
)

...
edi_path = Path(r"c:\Users\jpeacock\OneDrive - DOI\Geothermal\Umatilla\EDI_Files_birrp_phase_02\final_edis")
edi_list = list(edi_path.glob("*.edi"))

save_dir_edi =Path(r"c:\Users\jpeacock\OneDrive - DOI\Geothermal\Umatilla\EDI_Files_birrp_phase_02\final_edi") 
save_dir_png = Path(r"c:\Users\jpeacock\OneDrive - DOI\Geothermal\Umatilla\EDI_Files_birrp_phase_02\final_png")
...
for edi_fn in edi_list:
    ...
    m.survey_metadata.geographic_name = "Confederated Tribes of the Umatilla Reservation, Oregon"
    ...
    m.station_metadata.provenance.comments = "Time series archived on Science Base https://doi.org/10.5066/P9DQJTL9"

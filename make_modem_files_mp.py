...
edi_path = (
    r"c:\Users\jpeacock\Documents\MountainPass\EDI_Files_birrp\Edited\geomag_north"
)
file_stem = "mp"
...
inv_period_list = np.logspace(-np.log10(625.0), np.log10(1024.0), num=23)
...
data_obj.write_data_file(
    ...
    fn_basename="{0}_modem_data_ef{1:02.0f}.dat".format(
        file_stem, data_obj.error_value_z
    ),
)

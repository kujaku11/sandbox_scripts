...
# Inputs
# ==============================================================================
edi_path = r"c:\Users\jpeacock\Documents\Geothermal\Camas\Camas_EDI_Files"
save_path = r"c:\Users\jpeacock\Documents\Geothermal\Camas\modem_inv\inv_01"

fn_stem = "cm"
s_edi_list = [
    os.path.join(edi_path, ss)
    for ss in os.listdir(edi_path)
    if ss.endswith(".edi") and ss[0:3] != "CP8"
]
...
data_obj.write_data_file(
    save_path=save_path,
    fn_basename="{1}_modem_data_err{0:02.0f}.dat".format(
        data_obj.error_value_z, fn_stem
    ),
)
...
cfg_obj.write_config_file(save_dir=save_path, config_fn_basename="Inv01.cfg")

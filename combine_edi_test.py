...
edi_fn_list = [
    r"c:\MT\MSHS\ms33\TS\BF\4096\MB000.edi",
...
sr_dict = {4096: (1000.0, 4), 1024: (3.99, 1.0), 256: (0.99, 0.04), 16: (0.039, 0.0001)}
...
for edi_fn in edi_fn_list:
    ...
    for fkey in sorted(sr_dict.keys(), reverse=True):
        if str(fkey) in edi_fn:
            ...
            data_arr["z_err"][count : count + len(f_index[0])] = edi_obj.Z.z_err[
                f_index
            ]

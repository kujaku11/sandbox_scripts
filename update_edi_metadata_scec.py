...
# =============================================================================
survey_csv_fn = r"c:\Users\jpeacock\OneDrive - DOI\SCEC_2019\scec_survey_summary.csv"
zmm_path = Path(r"c:\Users\jpeacock\OneDrive - DOI\SCEC_2019\zmm_final")
zmm_list = list(zmm_path.glob("*.zmm"))

save_dir_edi = Path(r"c:\Users\jpeacock\OneDrive - DOI\SCEC_2019\final_edi")
save_dir_png = Path(r"c:\Users\jpeacock\OneDrive - DOI\SCEC_2019\final_png")

# =============================================================================
survey_df = pd.read_csv(survey_csv_fn)


for zmm_fn in zmm_list:
    ...
    sdf = [
        entry for entry in survey_df.loc[survey_df.station == zmm_fn.stem].itertuples()
    ][0]
    ...
    m.survey_metadata.summary = (
        ...
        "Palms Oasis funded led by Pieter Share MacParland then at the "
    ...
    # Station
    m.station_metadata.acquired_by.author = "U.S. Geological Survey and SCRIPPS"
    ...
    m.station_metadata.provenance.software.version = "0.1.7"

...
# =============================================================================
edi_list_01 = [
    os.path.join(edi_path_01, ss)
    for ss in os.listdir(edi_path_01)
    if ss.endswith(".edi")
]

edi_list_02 = [
    os.path.join(edi_path_02, ss)
    for ss in os.listdir(edi_path_02)
    if ss.endswith(".edi")
]
...
# Make the data file
# ==============================================================================
inv_period_list = np.logspace(np.log10(0.003125), np.log10(1450.0), num=23)
...
mod_obj.cell_size_east = 3000.0
mod_obj.cell_size_north = 3000.0
mod_obj.pad_east = 6
mod_obj.pad_north = 6
...
mod_obj.n_layers = 40
mod_obj.z1_layer = 10
mod_obj.z_target_depth = 70000.0

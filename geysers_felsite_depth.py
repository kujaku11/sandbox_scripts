...
m3_fn = r"c:\Users\jpeacock\Documents\ClearLake\modem_inv\inv03\gz_err03_cov02_NLCG_057.rho"
...
def interp_grid(old_model_obj, new_model_obj, shift_east=0, shift_north=0, 
    ...
    if dim == '2d':
        ...
        for zz in range(new_model_obj.plot_z.shape[0]):
            ...
            new_res[:, :, zz] = interpolate.griddata((north.ravel(), east.ravel()),
        ...
        new_res = interpolate.griddata((north.ravel(), east.ravel(), vert.ravel()),

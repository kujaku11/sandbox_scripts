...
station_list = [162, 164, 165, 167, 168, 169, 170, 171, 
                172, 175, 176, 177, 177, 178, 179, 
                180, 181, 182, 188, 189, 190, 191, 192, 196, 197, 198, 199, 
                200, 220, 221, 222, 224, 225, 226, 231, 232, 235, 236, 237]
...
for edi_lst, folder in zip([edi_list_ps, edi_list_ga, edi_list_dp], 
                           ['ps', 'ga', 'dp']):
    ws_data = ws.WSData(edi_list=edi_lst+edi_list_lv, period_list=inv_periods, 
    ...
    ws_data_fn = os.path.join(save_path, 'Inv2_{0}'.format(folder), 

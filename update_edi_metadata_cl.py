...
survey_csv_fn = r"c:\Users\jpeacock\OneDrive - DOI\ClearLake\clear_lake_mt_survey_summary.csv"

edi_path = Path(r"c:\Users\jpeacock\OneDrive - DOI\ClearLake\EDI_files_birrp")
edi_list = [fn for fn in list(edi_path.glob("*.edi")) if "cl3" in fn.name]
...
for edi_fn in edi_list:
    ...
    m.survey_metadata.geographic_name = "Clear Lake"
    m.survey_metadata.name = "Clear Lake 2022"
    ...
    m.survey_metadata.project = "Clear Lake"
    ...
    m.survey_metadata.summary = "Imnaging the Clear Lake Volcanic System"
    m.survey_metadata.id = "CL2021"
    ...
    try:
        ...
        m.hz_metadata.sensor.serial_number = hz_sensor
        ...
        print(f"{m.station} has no HZ")

    m.write_tf_file(
        save_dir=r"c:\Users\jpeacock\OneDrive - DOI\ClearLake\EDI_files_birrp\updated"
    )

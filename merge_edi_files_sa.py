...
lp_fn = r"c:\Users\jpeacock\Documents\SaudiArabia\EDI_Files\GeomagneticNorth_original_lp\{0}.edi".format(
    station
)
bb_fn = r"c:\Users\jpeacock\Documents\SaudiArabia\EDI_Files\GeomagneticNorth_original\{0}.edi".format(
    station
)
...
merged_z_obj = mt.MTz.Z(
    z_array=np.append(bb_z, lp_z, axis=0),
...
merged_t_obj = mt.MTz.Tipper(
    tipper_array=np.append(bb_t, lp_t, axis=0),
...
new_fn = lp_obj.write_mt_file(
    save_dir=r"c:\Users\jpeacock\Documents\SaudiArabia\EDI_Files\GeomagneticNorth_original_combined",

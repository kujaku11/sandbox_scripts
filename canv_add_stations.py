...
new_stations = [
    "DVAMT-D2", "DVAMT-E2", "DVAMT-E4", "DVAMT-F3", "DVAMT-F5", "DVAMT-F7",
    "DVAMT-E7"]
...
# add average files
avg_path = Path(r"c:\Users\jpeacock\OneDrive - DOI\Geothermal\GreatBasin\modem_inv\canv_01\new_edis")
...
d.write_data_file(fn_basename="gb_modem_data_z03_t02.dat",

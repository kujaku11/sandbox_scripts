...
mod_obj.cell_size_north = 1500.0
mod_obj.pad_num = 5
mod_obj.pad_east = 5
mod_obj.pad_north = 5
...
new_north = (
    ...
    + [round(2000 + 2000 * 0.15 * ii) for ii in range(12)][::-1]
    + [1500] * 75
    + [round(2000 + 2000 * 0.15 * ii) for ii in range(5)]
    + list(mod_obj.nodes_north[0:4])[::-1]
)

new_east = (
    list(mod_obj.nodes_east[0:3])
    + [round(2000 + 2000 * 0.15 * ii) for ii in range(15)][::-1]
    + [1500] * 80
    + [round(2000 + 2000 * 0.15 * ii) for ii in range(5)]

...
# rename usf files
if usf:
    summary_fn = Path(r"c:\Users\jpeacock\OneDrive - DOI\Geothermal\Umatilla\TEM\project_summary.csv") 
...
# rename .ml files
if ml:
    channel_dict = {'1': "HM-RC005",
                    '2': "HM-RC200",
                    '3': "LM-RC005",
                    '4': "LM-RC200"}
    model_dir = Path(r"c:\Users\jpeacock\OneDrive - DOI\Geothermal\Umatilla\TEM\Models\blocky")
    ...
    for folder in model_dir.iterdir():
        ...
        for ml_file in ml_files:
            new_fn = save_dir.joinpath(f"{folder.name}_{channel_dict[ml_file.stem[-4]]}.tem")

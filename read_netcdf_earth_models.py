...
def project_grid(latitude, longitude, utm_zone=None, epsg=None, 
                 shift_east=0.0, shift_north=0.0):
    """
...
# =============================================================================
nc_fn = Path(
    r"c:\Users\jpeacock\OneDrive - DOI\earth_models\western_us_s_waves_Casc19-VS.nc"
    )
...
x_obj, grid = read_nc_file(nc_fn, utm_zone=model_utm, 
                             shift_east=-model_east + 150000,
                             shift_north=-model_north - 100000,
                             units="km")

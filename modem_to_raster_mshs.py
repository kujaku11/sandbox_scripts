...
model_fn = r"c:\Users\jpeacock\Documents\Geothermal\Washington\MSHS\modem_inv\mshs_err03_cov03_NLCG_070.rho"


save_path = r"c:\Users\jpeacock\Documents\Geothermal\Washington\MSHS\modem_inv\mshs_model_slices_070"
# save_path = r"/mnt/hgfs/jpeacock/Documents/LV/Maps/geo_model_slices_02"
# model_center = (-118.833, 37.815) # lv center
model_center = (-122.156653, 46.097751)  # lv16 lower left
...
ll_cc = modem_raster.get_model_lower_left_coord(
    model_center=model_center, pad_east=12, pad_north=12
)
modem_raster.lower_left_corner = (ll_cc[0] - 0.00, ll_cc[1] - 0.010)
